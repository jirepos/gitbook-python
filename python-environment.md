...
package_spec을 명시해서 필요한 패키지를 가상환경 생성시에 한번에 설치할 수 있다.
...
numpy 패키지를 설치를 해보자. 가상환경 디렉토리의 Lib 디렉토리 아래의, site_packages 디렉토리 아래에 설치되는 것을 확인할 수 있다.
...
> 반드시 패키지로 만들 디렉토리는 \__init\_\_.py 파일을 생성해야 한다.
